  ...
  onSubmit(form: NgForm): void {
    ...
    if (form.valid) {
      ...
      const newRecipe: RecipeModel = {
        ...
        preparationTime: form.value.preparationTime, // na razie nie mamy kontrolki, dodajemy predefiniowaną wartość
        difficulty: form.value.difficulty // na razie nie mamy kontrolki, dodajemy predefiniowaną wartość
      };
